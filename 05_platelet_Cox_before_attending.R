...
tidy_data_dia_before_att <- subset(
  tidy_data,
...
write.xlsx(platelet_multi_Cox, "05/platelet_multi_Cox.xlsx", TRUE)
write.xlsx(platelet_uni_Cox, "05/platelet_uni_Cox.xlsx", TRUE)
write.xlsx(platelet_multi_Cox_excl_blood, "05/platelet_multi_Cox_excl_blood.xlsx", TRUE)
write.xlsx(platelet_uni_Cox_excl_blood, "05/platelet_uni_Cox_excl_blood.xlsx", TRUE)
